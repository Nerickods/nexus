---
description: "Inicializar contexto del proyecto para el asistente AI. Usa esto al comenzar una nueva conversación para que el agente entienda rápidamente tu proyecto."
---
...
// turbo
Lee `saas-factory/CLAUDE.md` y extrae:
- **Nombre del proyecto**
