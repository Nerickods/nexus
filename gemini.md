...
│   └── migrations/
├── .claude/                 # Configuración de Herramientas (Legacy)
...
- Seguir principles de gemini.md
...
### Context Priority
1. **gemini.md rules** (highest priority)
...
# 2. Monitor logs in real-time (Gemini)
